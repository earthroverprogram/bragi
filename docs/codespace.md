...
![my repo](images/my_repo.png "New Repo")
1. Open the repo in a Codespace (wait while the Codespace builds).
![codespace](images/codespace.png "Codespace")
1. Open and build [dummy_report.tex](content/tex/dummy_report.tex).
![build](images/build.png "Build LaTeX")
1. Use the commands provided by LaTeX Workshop.
![LaTeX](images/latex.png "LaTeX Workshop")
